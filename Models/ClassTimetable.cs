...
public class ClassTimetable : NotifyPropertyChangedBase
{
    ...
    {
        get => _grade;
        set { if (SetProperty(ref _grade, value)) Notify(nameof(ClassInfo)); }
    }
    ...
    {
        get => _class;
        set { if (SetProperty(ref _class, value)) Notify(nameof(ClassInfo)); }
    }
    ...
    {
        get => _dayOfWeek;
        // ClassTimetableEditDialog 이 DayName 을 Mode=OneWay 로 걸어 두었다.
        set { if (SetProperty(ref _dayOfWeek, value)) Notify(nameof(DayName)); }
    }
