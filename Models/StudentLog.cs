...
public class StudentLog : NotifyPropertyChangedBase
{
    ...
    {
        get => _log;
        set { if (SetProperty(ref _log, value)) NotifySummary(); }
    }
    ...
    {
        get => _activityName;
        set { if (SetProperty(ref _activityName, value)) NotifySummary(); }
    }
    ...
    {
        get => _topic;
        set { if (SetProperty(ref _topic, value)) NotifySummary(); }
    }
    ...
    {
        get => _description;
        set { if (SetProperty(ref _description, value)) NotifySummary(); }
    }
